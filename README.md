...
当前有 **信号与系统 L01–L04、核工程原理 L01–L03、聚变能源概论 L01–L02**。随课程推进增量更新；实际收录与课堂覆盖范围以各讲来源记录为准。
...
- 完整讲义按知识主线展开解释、推导与例题；课堂回顾按实际授课顺序组织。
- 来源、订正和资料覆盖情况集中在“来源与订正”中，便于需要时核对。
...
更新先在本地积累，由维护者明确要求后集中发布。发布流程见[更新与同步](docs/PUBLISHING.md)。欢迎通过 Issues 指出具体课程、讲次、主题及依据，帮助核查错误。
