...
## L04：傅里叶级数（2026-09-22）

[L04来源与订正](../Lectures/L04/Lecture_Source_Map.md)登记本次三份原件，用户已明确确认均可公开发布。93个转写块归入44段，48页课件全部登记，原音86:29.4未核听。开头补讲Ch2因果/稳定性；FT及其重要定理仅预告。

教材本轮实际精读PDF110–113、115–116、120–123、187、189，188仅定位排除，其余109–130/186–189新增页只渲染。3-9题干在187、图在189。课件41图±E与式2E/π不配，教材120–121图±E/2提供对照；1/t反例、相位象限、奇谐定义、零点含0、常数极限及Gibbs条件均在当地注明，不暗改Raw。
